...
A powerful command-line toolkit for SOC analysts and incident responders, powered by the [DFIR Lab](https://platform.dfir-lab.ch/api-keys) API. Analyze phishing emails, enrich indicators of compromise, and scan for external exposure — all from your terminal.
...
Get your API key from the [DFIR Lab Platform](https://platform.dfir-lab.ch/api-keys) dashboard, then run:
